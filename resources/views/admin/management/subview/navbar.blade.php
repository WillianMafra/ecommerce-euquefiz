<aside id="sidebar" class="sidebar bg-dark">
    <ul class="sidebar-nav " id="sidebar-nav">
        ...
        <li class="nav-item"><a class="nav-link " href="{{route('management')}}"><i class="bi bi-grid"></i> <span>Voltar ao Dashboard</span></a>
        </li>
        ...
        <li class="nav-item  bg-light">
            <a class="nav-link collapsed" data-bs-target="#orders-nav" data-bs-toggle="collapse" href="#"> <i class="bi bi-menu-button-wide "></i><span>Notas Fiscais</span><i class="bi bi-chevron-down ms-auto"></i></a>
