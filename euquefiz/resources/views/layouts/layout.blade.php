...
<head><!-- CSS only -->
    ...
    @stack('style')
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Caveat:wght@500&family=Pacifico&display=swap');
        @import url('https://fonts.googlea.com/css2?family=Caveat:wght@500&family=Ms+Madi&display=swap');
    </style>
