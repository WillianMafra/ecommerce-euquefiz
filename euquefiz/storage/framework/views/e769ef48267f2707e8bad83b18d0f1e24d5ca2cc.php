...
<head>
    ...
    <?php echo $__env->yieldPushContent('adminStyle'); ?>
    <link href="<?php echo e(asset('storage/img/logo-design/LogoSemFundo.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('storage/img/logo-design/LogoSemFundo.png')); ?>" rel="apple-touch-icon">
    <link href="https://fonts.gstatic.com" rel="preconnect">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/dashboard/style.css')); ?>">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/dashboard/css.css')); ?>">
</head>
<body class="bg-dark">
<header id="header" class="header fixed-top d-flex align-items-center bg-dark">
    <div class="d-flex align-items-center justify-content-between"> <a href="#" class="logo d-flex align-items-center">
            <img src="<?php echo e(asset('storage/img/logo-design/LogoSemFundo.png')); ?>" alt="Eu Que Fiz Logo">
    ...
    <nav class="header-nav ms-auto bg-light rounded p-2">
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown p-3 bg-light rounded">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown"> <img src="<?php echo e(asset('storage/img/chefs/walter-white.jpg')); ?>" alt="Profile" class="rounded-circle"> <span class="d-none d-md-block dropdown-toggle ps-2">Jassa</span> </a>
...
<?php echo $__env->yieldPushContent('adminScript'); ?>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-u1OknCvxWvY5kfmNBILK2hRnQC3Pr17a+RTT6rIHI7NnikvbZlHgTPOOmMi466C8" crossorigin="anonymous"></script>
<script src="<?php echo e(asset('js/admin/dashboard/main.js')); ?>"></script>
<script src="<?php echo e(asset('js/admin/dashboard/scripts.js')); ?>"></script>
</body>
</html>
<?php /**PATH /home/adriano/repos/e2122/php/g2/ecommerce-euquefiz/euquefiz/resources/views/admin/management/adminHeader.blade.php ENDPATH**/ ?>