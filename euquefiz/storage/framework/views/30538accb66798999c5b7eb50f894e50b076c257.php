    ...
    <ul class="sidebar-nav " id="sidebar-nav">
        ...
        <li class="nav-item bg-light ">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li> <a href="<?php echo e(route('createProduct')); ?>"> <i class="bi bi-circle"></i><span>Adicionar Produto</span> </a></li>
            </ul>
        </li>
        <li class="nav-item bg-light">
                        ...
                        <div class="card top-selling overflow-auto">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row"><a href="#"><img src="<?php echo e(asset('storage/img/pratos/feijoada.jpg')); ?>" alt=""></a></th>
...
<?php echo $__env->make('admin.management.adminHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adriano/repos/e2122/php/g2/ecommerce-euquefiz/euquefiz/resources/views/admin/management/dashboard.blade.php ENDPATH**/ ?>